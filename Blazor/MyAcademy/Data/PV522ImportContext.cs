...
{
    public PV522ImportContext()
    {
    }

    public PV522ImportContext(DbContextOptions<PV522ImportContext> options)
        : base(options)
    {
    }
    ...
    //    => optionsBuilder.UseSqlServer("Server=HOME-PC\\SQLEXPRESS;Database=PV_522_Import;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DaysOff>(entity =>
        {
            ...
            entity.HasOne(d => d.HolidayNavigation).WithMany(p => p.DaysOffs)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DaysOFF_Holidays");
        });
